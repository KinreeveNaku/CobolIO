...
@SuppressWarnings({ "unused", "squid:S109", "squid:S1068", "squid:S3776", "squid:S128", "squid:CommentedOutCodeLine", "squid:SwitchLastCaseIsDefaultCheck", "squid:S1821", "squid:S1151", "squid:S4524" })
public class CobolDescriptor {
	...
	private static byte[] baseDesc = new byte[] { 18, DESC_NUMERICEDITEDBWZ, 6, 2, 14, LOW_NIBBLE_MASK, DESC_COMP1,
			-108, -104, DESC_ALPHANUMERICEDITED };
	...
	protected boolean isAlphanumericEdited() {
		return this.descriptor[0] == -109 || this.descriptor[0] == -110;
	}

	protected boolean isNumericEdited() {
		return this.descriptor[0] == -112 || this.descriptor[0] == -111;
	}

	protected boolean isComp1() {
		return this.descriptor[0] == -128;
	}

	protected boolean isComp2() {
		return this.descriptor[0] == -127;
	}
	...
	protected static CobolDescriptor makeEditedDescriptor(int var0, int var2, int var3, String var4) {
		byte desc = baseDesc[var2];
